...
def modified_wrapper(X_mixture,X_component, thres_par=None, lambda_0=None, lambda_1=None):                 
    """ 
    A modified verison of wrapper() at:
    https://github.com/ML-KULeuven/SAR-PU/blob/c51f8af2b9604c363b6d129b7ad03b8db488346f/lib/km/km/Kernel_MPE_grad_threshold.py#L143
    ...
    N=X_mixture.shape[0]                                                                     
    M=X_component.shape[0]
    lambda_values = [lambda_0,lambda_1]
