...
def main():
    ...
    elkan_model = lpu.models.geometric.elkanGGPC.ElkanGGPC(config, inducing_points_initial_vals=inducing_points_initial_vals, training_size=len(train_loader.dataset))
