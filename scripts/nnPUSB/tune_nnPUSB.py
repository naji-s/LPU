...
def main(num_samples=1, max_num_epochs=10, gpus_per_trial=0, results_dir=None):
    ...
    search_space = {
        ...
        "batch_size": {
            "train": ray.tune.choice([64, 128, 256]),
            "test": ray.tune.choice([64, 128, 256]),
            "val": ray.tune.choice([64, 128, 256]),
            "holdout": ray.tune.choice([64, 128, 256])
        },
    }
    ...
    result = ray.tune.run(
        lpu.scripts.nnPUSB.run_nnPUSB.train_model,
